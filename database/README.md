...
- `update_questions_by_area.sql`: troca perguntas repetidas por perguntas especificas por competencia.
...
11. Execute `update_questions_by_area.sql` se o questionario estiver mostrando perguntas repetidas.
